...
<section id="basic-footer">
  ...
  <footer class="footer bg-light">
    <div class="container-fluid d-flex flex-md-row flex-column justify-content-between align-items-md-center gap-1 container-p-x py-3">
      <div>
        <a href="<?php echo e(config('variables.livePreview')); ?>" target="_blank" class="footer-text fw-bolder"><?php echo e(config('variables.templateName')); ?></a> ©
      </div>
      <div>
...
<?php echo $__env->make('layouts/contentNavbarLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sneat-html-admin-template\html-laravel-free\full-version\resources\views/content/user-interface/ui-footer.blade.php ENDPATH**/ ?>