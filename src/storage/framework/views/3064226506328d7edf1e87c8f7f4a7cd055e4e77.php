        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="modalCenterTitle">Add a new contact to <?php echo e($client->name); ?>'s contact list</h5>
              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <?php $__env->startComponent('content.management.add-contact-form'); ?>
        ...
        $(document).on('blur', '.column_name.editable', function() {
          ...
          if (column_value != '') {
              if (column_name == 'contact_phone') {
                  ...
                  $.ajax({
                      url: "<?php echo e(route('livetable.check_email')); ?>",
                      method: "POST",
                      data: {
...
<?php /**PATH C:\Users\DanielOliveira\Desktop\Roboyo\roboyo_pentest_report_tool\resources\views/content/management/show-contact-table.blade.php ENDPATH**/ ?>