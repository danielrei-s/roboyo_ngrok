                              ...
                              <div class="d-flex justify-content-center align-items-center">
                                <label for="picture" style="cursor: pointer;">
                                  <div class="rounded-circle overflow-hidden" style="width: 150px; height: 150px;">
                                    <img src="<?php echo e(asset($user->picture)); ?>" alt="Profile picture" id="picturePreview" class="w-100 h-100">
                                  </div>
                                </label>
                              </div>
...
<?php /**PATH C:\Users\DanielOliveira\Desktop\Roboyo\roboyo_pentest_report_tool\resources\views/content/management/edit-user.blade.php ENDPATH**/ ?>