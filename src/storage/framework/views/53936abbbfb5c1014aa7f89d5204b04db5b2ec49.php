    ...
    <table class="table table-dark" style="min-height: 240px;">  <!-- min height prevent overlaps when there are < 2 entries -->
      ...
      <tbody class="table-border-bottom-0">
        <?php $__currentLoopData = $userObjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
            <td><img src="<?php echo e(secure_asset($user->picture)); ?>" alt="<?php echo e($user->firstName); ?> <?php echo e($user->lastName); ?>"
        ...
        <script src="<?php echo e(secure_asset('assets/js/table-sort.js')); ?>"></script>
      </tbody>
    </table>
...
<?php echo $__env->make('layouts/contentNavbarLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DanielOliveira\Desktop\Roboyo\roboyo_ngrok\resources\views/content/management/user-management.blade.php ENDPATH**/ ?>