  ...
  <tr>
    ...
    <th>Actions</th>
      ...
      <tbody class="table-border-bottom-0">
        ...
        <tr>
          <td><img src="<?php echo e(secure_asset($client->logo)); ?>" alt="<?php echo e($client->name); ?>" class="rounded-circle" style="width: 50px; height: 50px;"></td>
...
<?php echo $__env->make('layouts/contentNavbarLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DanielOliveira\Desktop\Roboyo\roboyo_ngrok\resources\views/content/management/client-management.blade.php ENDPATH**/ ?>