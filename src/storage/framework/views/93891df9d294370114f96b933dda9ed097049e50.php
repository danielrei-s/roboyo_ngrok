      ...
      <div class="card mb-4">
          ...
          <div class="card-body">
              <div class="d-flex align-items-md-center px-5 gap-4" >
                  <img src="<?php echo e(secure_asset(auth()->user()->picture)); ?>"
                  ...
                  <div style="border-left: 2px dashed #ccc; padding-left: 100px; padding-right: 20px;">
                      ...
                      <div class="button-wrapper">
                          <div class="d-flex justify-content-end gap-4">
                              ...
                              <img src="<?php echo e(secure_asset('assets/img/roles/' . $role . '.png')); ?>" alt="role-avatar"
                                  ...
                                  <div class="accordion-body">
                                    ...
                                    <div class="card-body">
                                      <form id="formAuthentication" class="mb-3" action="<?php echo e(route('auth-edit-main')); ?>" method="POST" style="padding: 20px;" enctype="multipart/form-data">
                                        ...
                                        <img src="<?php echo e(secure_asset(auth()->user()->picture)); ?>" alt="user-avatar" class="d-block rounded" height="100" width="100" id="uploadedAvatar" />
...
<?php echo $__env->make('layouts/contentNavbarLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DanielOliveira\Desktop\Roboyo\roboyo_ngrok\resources\views/content/dashboard/dashboards-main.blade.php ENDPATH**/ ?>